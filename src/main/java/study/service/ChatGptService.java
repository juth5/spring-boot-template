...
import study.constants.UmlType;
...
//chatGPTのAPIを叩く
    public String callChatGptMermaid(ChatRequestParameter param) {
        ...
        String caution = UmlType.findCaution(param.getUmlType());
        sb.append(caution).append("\n");
        // 2. 日本語エイリアスの解釈ミスを防ぐ
        ...
        // 5. 出力形式の固定
        sb.append("4. 出力は必ずマークダウンのコードブロック形式（```mermaid ～ ```）のみとし、解説、導入文、結びの言葉などは1文字も出力しないでください。\n\n");
